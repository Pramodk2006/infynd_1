"""
Test enhanced classifier v2 with LLM re-ranking enabled
"""
...
if __name__ == "__main__":
    ...
    print(f"\nTesting Enhanced Classifier V2 with LLM Re-Ranking on: {company}\n")
    
    result = classify_company_topk_v2(
        company,
        use_ollama_summary=True,
        use_llm_rerank=True,  # ENABLE LLM for uncertain cases
        k_sectors=5,
        k_industries=5,
        k_subindustries=10,
