"""
Compare Ollama and Top-K Hierarchical classifiers on company in data/outputs/2
"""
...
def main():
    ...
    save_classification_result(topk_result, 'company_2_topk.json')
